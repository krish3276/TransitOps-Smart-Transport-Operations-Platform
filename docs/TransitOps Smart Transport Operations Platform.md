...
- Utilization (%). Display KPIs such as Active Vehicles, Available Vehicles, Vehicles in Maintenance, Active Trips, Pending Trips, Drivers On Duty, and Fleet
...
- Display Fuel Efficiency (Distance/Fuel), Fleet Utilization, Operational Cost, and Vehicle ROI[\frac{Revenue - (Maintenance + Fuel)}{Acquisition Cost}].
...
[Mockup: https://link.excalidraw.com/l/65VNwvy7c4X/1FHGDNgD2td](https://link.excalidraw.com/l/65VNwvy7c4X/1FHGDNgD2td)
